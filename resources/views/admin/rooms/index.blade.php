...
@section('content')
    ...
    />
    <div
        class="relative mt-4 flex w-full min-w-0 flex-col gap-4 lg:grid lg:grid-cols-12 lg:items-start lg:gap-6"
            ...
            >
                <div class="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
                    <div class="min-w-0 flex-1">
                        @include('rooms.partials.room-filters-search', [
                            'filters' => $filters,
                            'filterFormId' => 'admin-rooms-filters',
                        ])
                    </div>
                    <label
                        for="admin-room-browse-filters-toggle"
                ...
                <div class="flex shrink-0 items-center max-sm:w-full max-sm:justify-end">
                    <a
                        ...
                        class="inline-flex h-12 min-h-12 shrink-0 items-center justify-center gap-2 rounded-2xl bg-teal-600 px-3.5 text-center text-sm font-medium text-white shadow-sm ring-1 ring-teal-600/20 transition hover:bg-teal-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/40"
                    >
