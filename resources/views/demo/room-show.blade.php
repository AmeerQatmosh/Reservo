...
@section('content')
    ...
    <x-page-breadcrumbs
        class="mb-4"
        :items="[
            ['label' => 'Rooms', 'url' => route('demo.rooms')],
            ['label' => $room['name']],
        ]"
    />
            ...
            <div class="space-y-5 lg:sticky lg:top-24">
                <div class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-sm sm:p-7">
                    ...
                    <p class="mt-2 text-sm text-gray-700">
                        Pick a date to see bookings in the sandbox. Then open <span class="font-medium text-gray-900">My reservations</span>—same steps as production.
                    ...
                    <form method="GET" action="{{ route('demo.room.show', $room['id']) }}" class="mt-5">
