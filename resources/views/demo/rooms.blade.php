    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-600">
                Same filters as production. On small screens, filters open in a sheet over the list; on large screens, use the left column.
            </p>
        </div>
        <a href="{{ route('demo.hub') }}" class="shrink-0 text-sm font-medium text-gray-700 hover:text-gray-900">Sandbox home</a>
    </div>
