...
@endphp
<div
    data-reservo-browse-surface
    class="relative mt-2 flex w-full min-w-0 flex-col gap-4 lg:grid lg:grid-cols-12 lg:items-start lg:gap-6"
    aria-live="polite"
>
    <input
        type="checkbox"
            ...
            <div class="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
                <div class="min-w-0 flex-1">
                    @include('rooms.partials.room-filters-search', [
                        'filters' => $filters,
                        'filterFormId' => 'rooms-browse-filters',
                    ])
                </div>
                <label
                    for="room-browse-filters-toggle"
