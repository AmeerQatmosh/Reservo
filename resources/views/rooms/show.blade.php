    ...
    <div class="mt-6 rounded-3xl border border-white/70 bg-white/90 p-7 shadow-sm">
        ...
        @auth
            <div class="mt-5 flex flex-col gap-3 rounded-2xl border border-blue-200 bg-blue-50 p-5 text-sm text-blue-900 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href="{{ route('reservations.my', ['room_id' => $room->id, 'date' => $selectedDate]) }}" class="reservo-loading-link inline-flex items-center justify-center gap-2 rounded-2xl bg-gray-900 px-4 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-gray-800">
