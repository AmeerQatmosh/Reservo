...
@else
    @if ($isMobile)
        ...
        <a href="{{ route('register') }}" class="group mt-1 flex w-full items-center justify-center gap-2 rounded-md bg-gray-900 px-2.5 py-2 text-[15px] font-semibold text-white transition hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-white/30">
    ...
    @else
        ...
        <a href="{{ route('register') }}" class="inline-flex items-center gap-2 whitespace-nowrap rounded-full bg-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-gray-800">
