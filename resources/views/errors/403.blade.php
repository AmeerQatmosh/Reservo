...
@section('content')
    <div class="mx-auto max-w-3xl py-10">
        <div class="rounded-3xl border border-white/70 bg-white/90 p-8 shadow-sm">
            <h1 class="text-3xl font-semibold tracking-tight text-gray-900">You do not have permission to view this page.</h1>
            ...
            <div class="mt-6 flex flex-col gap-3 sm:flex-row">
                @auth
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center rounded-2xl bg-teal-600 px-4 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-teal-700">
                        Back to dashboard
                    </a>
                @endauth
