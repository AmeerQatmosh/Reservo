...
export default function AuthSplitLayout({
    ...
    return (
        <div className="relative min-h-svh w-full overflow-x-hidden bg-[#f8fafc] lg:grid lg:min-h-dvh lg:grid-cols-[minmax(0,28rem)_minmax(0,1fr)] xl:grid-cols-[minmax(24rem,34rem)_minmax(0,1.12fr)]">
