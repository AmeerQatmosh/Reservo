...
final class DemoState
{
    ...
    {
        $photo = static fn (string $file): string => asset('images/demo/rooms/'.$file);
        ...
        return [
            'rooms' => [
                [
                    ...
                    'name' => 'Focus Pod',
                    'capacity' => 4,
                    'location' => 'North wing · Pod A',
                    'description' => 'Quiet four-person space with acoustic panels and a wall-mounted display. Ideal for interviews, 1:1s, and focused team sessions.',
                    'size_sqm' => 14,
                    'hourly_rate' => 28.00,
                    'amenities' => ['HD display', 'Video call ready', 'Whiteboard', 'Power outlets'],
                    'image_url' => $photo('focus-pod.jpg'),
                ],
                [
                    'id' => 2,
                    'name' => 'Studio B',
                    'capacity' => 12,
                    'location' => 'Creative floor · Studio wing',
                    'description' => 'Bright workshop studio with modular tables and writable surfaces. Fits stand-ups, design sprints, and training blocks.',
                    'size_sqm' => 42,
                    'hourly_rate' => 55.00,
                    'amenities' => ['Projector', 'Flip charts', 'Catering area', 'Natural light'],
                    'image_url' => $photo('studio.jpg'),
                ],
                [
                    'id' => 3,
                    'name' => 'Town Hall',
                    'capacity' => 40,
                    'location' => 'Ground floor · Events',
                    'description' => 'Large open room for all-hands, onboarding, and company events. Stage area at one end; AV rack included.',
                    'size_sqm' => 120,
                    'hourly_rate' => 120.00,
                    'amenities' => ['PA system', 'Wireless mics', 'Stage lighting', 'Wheelchair access'],
                    'image_url' => $photo('town-hall.jpg'),
                ],
                [
                    'id' => 4,
                    'name' => 'Glass Boardroom',
                    'capacity' => 10,
                    'location' => 'Executive suite · Level 4',
                    'description' => 'Corner glass boardroom with city views, conference phone, and wired HDMI. Suited to client reviews and leadership syncs.',
                    'size_sqm' => 28,
                    'hourly_rate' => 75.00,
                    'amenities' => ['Conference phone', 'HDMI', 'Climate control', 'City view'],
                    'image_url' => $photo('glass-boardroom.jpg'),
                ],
                [
                    'id' => 5,
                    'name' => 'Creative Lounge',
                    'capacity' => 8,
                    'location' => 'Creative floor · Hub',
                    'description' => 'Soft seating and coffee tables for informal brainstorms, async stand-ups, and cross-team catch-ups.',
                    'size_sqm' => 35,
                    'hourly_rate' => 35.00,
                    'amenities' => ['Sofa seating', 'Coffee machine', 'Portable screen', 'Natural light'],
                    'image_url' => $photo('creative-lounge.jpg'),
                ],
                [
                    'id' => 6,
                    'name' => 'Interview Suite',
                    'capacity' => 3,
                    'location' => 'North wing · HR',
                    'description' => 'Small neutral room optimized for candidate interviews with good lighting and minimal distractions.',
                    'size_sqm' => 10,
                    'hourly_rate' => 22.00,
                    'amenities' => ['Ring light', 'Laptop stand', 'Sound dampening', 'Scheduling display'],
                    'image_url' => $photo('interview-suite.jpg'),
                ],
                [
                    'id' => 7,
                    'name' => 'Boardroom',
                    'capacity' => 16,
                    'location' => 'Executive suite · Level 4',
                    'description' => 'Formal board table, leather chairs, and integrated AV for board meetings and executive workshops.',
                    'size_sqm' => 45,
                    'hourly_rate' => 95.00,
                    'amenities' => ['Video wall', 'Recording', 'Catering hatch', 'Blinds'],
                    'image_url' => $photo('boardroom.jpg'),
                ],
            ],
            'next_room_id' => 8,
        ];
